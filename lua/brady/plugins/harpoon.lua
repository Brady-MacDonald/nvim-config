return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>hg", function() harpoon:list():select(1) end)
        vim.keymap.set("n", "<leader>hf", function() harpoon:list():select(2) end)
        ...
        vim.keymap.set("n", "<leader>ha", function() harpoon:list():select(5) end)
